...
@property (copy, nonatomic) void(^actionHandler)(HRAlertAction *action);
...
+ (instancetype)actionWithTitle:(NSString *)title handler:(void (^)(HRAlertAction *action))handler {
    HRAlertAction *instance = [HRAlertAction new];
...
+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message {
    ...
    HRAlertViewController *instance = [HRAlertViewController new];
...
- (void)didClickButton:(UIButton *)sender {
    HRAlertAction *action = self.actions[sender.tag-10];
